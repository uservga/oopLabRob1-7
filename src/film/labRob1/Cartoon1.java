...
public class Cartoon1 {
    ...
    public Cartoon1(String name, String country, double rate, TimeWatching timeWatching, int budget) {
        this.name = name;
    ...
    public Cartoon1(String name, String country, Data data, int budget) {
        this.name = name;
        this.country = country;
        this.data = data;
        this.budget = budget;
